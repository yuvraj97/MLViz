...
def plot_predition(X, theta, fig, inputs):
    ...
    if d == 1:
        ...
        new_fig: Figure = mesh3d(
            ...
            [
                (theta[0][0] + theta[1][0] * min_X + theta[2][0] * min_X2) * norm_std + norm_mean,
                (theta[0][0] + theta[1][0] * min_X + theta[2][0] * max_X2) * norm_std + norm_mean,
                (theta[0][0] + theta[1][0] * max_X + theta[2][0] * min_X2) * norm_std + norm_mean,
                (theta[0][0] + theta[1][0] * max_X + theta[2][0] * max_X2) * norm_std + norm_mean,
            ],
            description,
            fig=fig,
            opacity=0.9
